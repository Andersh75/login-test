...
export function XLoggedinCreator(theuser) {
    return class XLoggedin extends connect(storeCreator(theuser))(usermixin(LitElement)) {
        connectedCallback() {
            super.connectedCallback();
            this.store = storeCreator(this.user);
            this.store.subscribe(() => this._stateChanged(store.getState()));
        }
